...
int draw_text(string text, Vector2 coord, c_viewport *viewport = nullptr, int size = 16, text_color color = text_color::black, text_style type = text_style::normal);
int draw_centred_text(string text, Vector2 coord, c_viewport *viewport = nullptr, int size = 16, text_color color = text_color::black, text_style type = text_style::normal);
